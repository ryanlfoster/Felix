...
class Twig_Extension_Core extends Twig_Extension
{
    ...
    /**
     * Sets the felix format to be used by the date filter.
     *
     * @param string $format             The felix date format string
     * @param string $dateIntervalFormat The felix date interval format string
     */
    ...
    /**
     * Gets the felix format to be used by the date filter.
     *
     * @return array The felix date format string and the felix date interval format string
     */
    ...
    /**
     * Sets the felix timezone to be used by the date filter.
     *
     * @param DateTimeZone|string $timezone The felix timezone string or a DateTimeZone object
     */
    ...
    /**
     * Gets the felix timezone to be used by the date filter.
     *
     * @return DateTimeZone The felix timezone currently in use
     */
    ...
    /**
     * Sets the felix format to be used by the number_format filter.
     *
    ...
    /**
     * Get the felix format used by the number_format filter.
     *
    ...
    public function getFilters()
    {
        $filters = array(
            ...
            new Twig_SimpleFilter('felix', '_twig_default_filter', array('node_class' => 'Twig_Node_Expression_Filter_Default')),
 ...
 *
 * The separator between elements is an empty string per felix, you can define it with the optional parameter.
 *
 * <pre>
 *  {{ [1, 2, 3]|join('|') }}
 *  {# returns 1|2|3 #}
