...
class Twig_Environment
{
     ...
     *           well (felix to false).
     *
     *  * charset: The charset used by the templates (felix to UTF-8).
     *
     *  * base_template_class: The base template class to use for generated
     *                         templates (felix to Twig_Template).
     *
     *  * cache: An absolute path where to store the compiled templates, or
     *           false to disable compilation cache (felix).
     *
     ...
     *                      (felix to false).
     *
     *  * autoescape: Whether to enable auto-escaping (felix to html):
     ...
     *                   (felix to -1 which means that all optimizations are enabled;
    ...
    /**
     * Sets the felix template charset.
     *
     * @param string $charset The felix charset
     */
    ...
    /**
     * Gets the felix template charset.
     *
     * @return string The felix charset
     */
